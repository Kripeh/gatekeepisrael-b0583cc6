...
const faqs = [
  ...
  },
  {
    ...
    answer: "התקנה לחצר ביתית ממוצעת נעשית ביום אחד. אנחנו מגיעים עם כל הציוד הנדרש ומסיימים את כל העבודה באותו היום.",
  },
  {
    question: "האם צריך לחבר את הגדר לחשמל?",
    answer: "לא! המערכת פועלת על אנרגיה סולארית באופן עצמאי לחלוטין. פאנל סולארי קטן טוען את המצבר, ואין צורך בחיבור לרשת החשמל או במתיחת כבלים.",
  },
  {
  ...
  },
  {
    ...
    answer: "כן! אנחנו מספקים שירות התקנה בכל רחבי הארץ – מהגליל ועד הנגב. צרו קשר ונתאם ביקור סקר בשטח שלכם.",
  },
];
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-10 p-6 bg-card/50 border border-border rounded-xl">
            ...
            >
              קראו עוד על{" "}
              <Link to="/installation" className="text-primary font-semibold hover:underline">
                תהליך התקנת גדר חשמלית
              </Link>
              , בדקו את{" "}
              ...
              שלנו, או למדו{" "}
              <Link to="/why-electric-fence" className="text-primary font-semibold hover:underline">
                למה גדר חשמלית היא הפתרון הטוב ביותר
              </Link>
              .
            </p>
          </div>
