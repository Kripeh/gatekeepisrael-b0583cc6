...
const keyPoints = [
  ...
  },
  {
    icon: Shield,
    title: "בטוחה למשפחה",
    description: "המחולל והרכיבים החשמליים עומדים בתקן בינלאומי שנועד להבטיח בטיחות מלאה לבני אדם. המערכת שולחת פולסים קצרים של מתח גבוה בזרם נמוך מאוד – מרתיע חיות אך אינו מסוכן לילדים או לחיות מחמד.",
  },
];
