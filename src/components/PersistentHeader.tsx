...
const PersistentHeader = () => {
  return <header className="fixed top-0 right-0 left-0 z-50 bg-background/95 backdrop-blur-md border-b border-border">
      <div className="container flex items-center justify-between py-3">
        ...
        {/* CTA Button */}
        <a href={PHONE_LINK} className="btn-cta-glow flex items-center gap-2 px-4 py-3 md:px-6 md:py-3 rounded-lg text-sm md:text-base pulse-urgent">שיחת ייעוץ מיידית<Phone className="w-5 h-5 animate-bounce-subtle" />
