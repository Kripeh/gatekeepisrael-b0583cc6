...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={HERO_BG_URL} alt="גדר חשמלית נגד חזירי בר - התקנה מקצועית בשטח חקלאי | גייטקיפ" className="w-full h-[120%] object-cover will-change-transform" style={{
      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Sub-headline */}
          <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-10 leading-relaxed" style={{
          textWrap: 'pretty'
        }}>
