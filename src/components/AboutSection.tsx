...
const teamMembers = [
  {
    name: "ענבר רוזנאי",
    role: "מומחיות אגרונומית",
    description: "דור שלישי למגדלי ענבים במושב לכיש. סטודנט לאגרונומיה בפקולטה לחקלאות באוניברסיטה העברית. מביא ידע עמוק בדפוסי תנועה של חיות בר ובהתאמת גידור לתנאי שטח ייחודיים.",
    icon: Sprout,
  },
  {
    name: "אפיק",
    role: "הנדסת קונסטרוקציה",
    description: "קבלן שלד ממושב שדה משה. מומחה לתשתיות וקונסטרוקציה עמידה. מוודא שכל גדר עומדת איתנה מול רוח, גשם וחדירות חוזרות של בעלי חיים.",
    icon: Wrench,
  },
  {
    name: "אמיתי קפלן",
    role: "הנדסת חשמל ובטיחות",
    description: "סטודנט להנדסת חשמל באוניברסיטת בן גוריון וחשמלאי מוסמך. מתמחה בתכנון מערכות מתח גבוה בטוחות לפי תקן. הצטרף לאחר 4 סבבי מילואים כדי להבטיח אפס תקלות ואפס סיכונים.",
    icon: Zap,
  },
  {
    name: "הצוות המבצעי",
    role: "אמינות ומשמעת",
    description: "כל העובדים הם חיילים משוחררים משירות קרבי, המביאים משמעת, דיוק ומחויבות לכל פרויקט. עבודה לפי לוח זמנים קפדני עם סטנדרט ביצוע גבוה.",
    icon: Users,
  },
];
